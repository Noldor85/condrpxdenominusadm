...
msgInfo = {
    init: function (s, d) {
        ...
        $(".loading").fadeIn()
        _post(beServices.CHAT.STATUS_DETAIL, tempObj, function (data) {
            $(".loading").fadeOut()
    ...
    loginInfo(function (doc) {
        ...
        db.get4Guest("chatId" + chatId, doc.estates[estateSelected].guestId).then(function (oldMsg) {
            try {
                ...
                _post(beServices.CHAT.READ_APP, tempObj, function (data) {
                    $(".loading").fadeOut()
...
$(document).on("tapend", "#ChatMsgNav .fa-trash-o", function () {
    showAlert($.t("DELETE_MESSAGES"), $.t("DELETE_ASK") + $(".chat_message.selected").length + " " + $.t("MESSAGES"), function () {
        loginInfo(function (doc) {
            ...
            console.log(tempObj)
            _post(beServices.CHAT.DELETE_MESSAGE_APP, tempObj, function () {
                $("#ChatMsgNav").html(chatBar)
                loginInfo(function (doc) {
...
downloadMsg = function (this_, recived, callback) {
    loginInfo(function (doc) {
        ...
        _post(beServices.CHAT.READ_MESSAGE_VALIDATE, tempObj, function (data) {
            console.log(data)
            try {
    ...
    if (checkPress(ev)) {
        ...
        showAlert($.t("CONFIRMATION"), $.t("DELETE_CHAT_CONFIRMATION"), function () {
            loginInfo(function (doc) {
                ...
                console.log(tempObj)
                _post(beServices.CHAT.DELETE_APP, tempObj, function (data) {
    ...
    getContactLists: function () {
        loginInfo(function (doc) {
            ...
            db.get("contacts").then(function (doc) {
                ...
                _post(beServices.CHAT.READ_USERS_GROUPS, tempObj, function (data) {
                    if (!$.isEmptyObject(data)) {
                        if ("users" in data) {
